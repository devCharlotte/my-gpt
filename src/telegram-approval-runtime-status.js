...
const STATUS_LOCALES = Object.freeze({
  en: {
    title: "Miffy Coding Mate Telegram status",
    labels: {
      transport: "Transport",
      health: "Health",
  ...
  zh: {
    title: "Miffy Coding Mate Telegram 状态",
    labels: {
      transport: "传输",
      health: "健康状态",
      nativePolling: "原生轮询",
  ...
  "zh-TW": {
    title: "Miffy Coding Mate Telegram 狀態",
    labels: {
      transport: "傳輸",
      health: "健康狀態",
      nativePolling: "原生輪詢",
  ...
  ko: {
    title: "Miffy Coding Mate Telegram 상태",
    labels: {
      transport: "전송",
      health: "상태",
  ...
  ja: {
    title: "Miffy Coding Mate Telegram ステータス",
    labels: {
      transport: "送信方式",
      health: "状態",
