...
function formatDiagnosticReport(result, meta = {}) {
  ...
  const lines = [
    "# Miffy Coding Mate Diagnostic Report",
    "",
    `- Generated: ${generatedAt}`,
    `- Miffy Coding Mate version: ${version}`,
  ...
  lines.push(
    "",
    "**Privacy notice**: This report is generated locally. Miffy Coding Mate does not upload any data. User paths are replaced with `~`, and Miffy Coding Mate app paths are replaced with `[APP]`. The report contains no API keys, tokens, conversation content, or document filenames."
  );
